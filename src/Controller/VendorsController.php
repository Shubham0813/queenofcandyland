...
class VendorsController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['Addresses', 'Representatives']
        ];
    ...
    public function view($id = null)
    {
        $vendor = $this->Vendors->get($id, [
            'contain' => ['Addresses', 'Representatives', 'Items']
        ]);
    ...
    public function add()
    {
        ...
        $addresses = $this->Vendors->Addresses->find('list', ['limit' => 200]);
        $representatives = $this->Vendors->Representatives->find('list', ['limit' => 200]);
        $this->set(compact('vendor', 'addresses', 'representatives'));
        $this->set('_serialize', ['vendor']);
    }
